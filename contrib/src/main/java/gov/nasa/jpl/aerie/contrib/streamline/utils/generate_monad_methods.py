...
TARGETS = [
    ...
    monad('ErrorCatching<Profile<{}>>', '../modeling/piecewise/monads/ProfileDynamicsMonad.java'),
    monad('ProfileResource<{}>', '../modeling/piecewise/monads/ProfileResourceMonad.java'),
]
