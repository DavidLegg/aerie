...
public record VariableClock(Duration time, int multiplier) implements Dynamics<Duration, VariableClock> {
  @Override
  ...
  public VariableClock step(final Duration t) {
    return new VariableClock(time.plus(t.times(multiplier)), multiplier);
  }
